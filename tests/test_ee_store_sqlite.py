...
def test_get_env_def(gateway, simple_env_def):
    gateway.session.add(EnvDef(id="266f486", long_hash="aaa", env_def={"packages": {"pkg-a": "1.2"}}))
    ...
    assert env_def_returned.long_id == "266f4866bd695aa64c0a93e0bc90348f7c4f8d50632fbaf208f268027ff54d91"
...
def test_save_and_get_exception(gateway, simple_env_def):
    gateway.session.add(EnvDef(id="a", long_hash="aaa", env_def={"packages": {"pkg-a": "1.2"}}))
    gateway.session.commit()
